...
def optimize_lgbmc(x_train, x_test, y_train, y_test, params={}, error_metric="accuracy_score", population_size=50,
...
class Optimizer:
    ...
    def objective(self, error_metric, row, x_train, x_test, y_train, y_test, random_seed):
        ...
        return self.get_mape(self.get_model(row, random_seed=random_seed), error_metric, x_train, x_test, y_train, y_test)
